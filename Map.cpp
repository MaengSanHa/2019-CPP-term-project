    ...
    switch(arrow){   
        ...
        */
        case 72 : // ↑ 입력
            ...
            else if (this->map[char_row-1][char_col] == 1){ // 캐릭터 위쪽이 벽이면
                do_nothing(); // 캐릭터 이동 불가능
            }
            else if (this->map[char_row-1][char_col] == 2){ // 캐릭터 위쪽이 박스일 때
                if ((this->map[char_row-2][char_col] == 1)||(this->map[char_row-2][char_col] == 2)){ // 박스 위쪽이 벽이거나 박스이면
                    do_nothing(); // 캐릭터 이동 불가능
                }
                else if (this->map[char_row-2][char_col] == 0){ // 박스 앞이 비어있으면
        ...
        case 75 : // <- 입력
            if ((this->map[char_row][char_col-1] == 0)||(this->map[char_row][char_col-1] == 3)){ // 캐릭터 왼쪽이 비어있거나 목적지이면 캐릭터를 왼쪽으로 한칸 전진
                setCharacter(char_row, char_col-1);
                setElement(char_row, char_col, default_map[char_row][char_col]);
                increaseNumStep();
            }
            else if (this->map[char_row][char_col-1] == 1){ // 캐릭터 왼쪽이 벽이면
                do_nothing(); // 캐릭터 이동 불가능
            }
            else if (this->map[char_row][char_col-1] == 2){ // 캐릭터 왼쪽이 박스일 때
                if ((this->map[char_row][char_col-2] == 1)||(this->map[char_row][char_col-2] == 2)){ // 박스 왼쪽이 벽이거나 박스이면
                    do_nothing(); // 캐릭터 이동 불가능
                }
                else if (this->map[char_row][char_col-2] == 0){ // 박스 앞이 비어있으면
                    setElement(char_row, char_col, default_map[char_row][char_col]); // 캐릭터 있던 곳은 기본 값
                ...
                else if (this->map[char_row][char_col-2] == 3){ // 박스 앞이 목적지이면
                    setElement(char_row, char_col, default_map[char_row][char_col]); // 캐릭터 있던 곳은 기본 값
                    setCharacter(char_row, char_col-1); // 캐릭터와 박스가 함께 왼쪽으로 이동
        ...
        case 77 : // -> 입력
            if ((this->map[char_row][char_col+1] == 0)||(this->map[char_row][char_col+1] == 3)){ // 캐릭터 오른쪽이 비어있거나 목적지이면 캐릭터를 오른쪽으로 한칸 전진
                setCharacter(char_row, char_col+1);
                setElement(char_row, char_col, default_map[char_row][char_col]);
                increaseNumStep();
            }
            else if (this->map[char_row][char_col+1] == 1){ // 캐릭터 오른쪽이 벽이면
                do_nothing(); // 캐릭터 이동 불가능
            }
            else if (this->map[char_row][char_col+1] == 2){ // 캐릭터 오른쪽이 박스일 때
                if ((this->map[char_row][char_col+2] == 1)||(this->map[char_row][char_col+2] == 2)){ // 박스 오른쪽이 벽이거나 박스이면
                    do_nothing(); // 캐릭터 이동 불가능
                }
                else if (this->map[char_row][char_col+2] == 0){ // 박스 앞이 비어있으면
                    setElement(char_row, char_col, default_map[char_row][char_col]); // 캐릭터 있던 곳은 기본 값
        ...
        case 80 : // ↓ 입력
            if ((this->map[char_row+1][char_col] == 0)||(this->map[char_row+1][char_col] == 3)){ // 캐릭터 아래쪽이 비어있거나 목적지이면 캐릭터를 아래쪽으로 한칸 전진
                setCharacter(char_row+1, char_col);
                setElement(char_row, char_col, default_map[char_row][char_col]);
                increaseNumStep();
            }
            else if (this->map[char_row+1][char_col] == 1){ // 캐릭터 아래쪽이 벽이면
                do_nothing(); // 캐릭터 이동 불가능
            }
            else if (this->map[char_row+1][char_col] == 2){ // 캐릭터 아래쪽이 박스일 때
                if ((this->map[char_row+2][char_col] == 1)||(this->map[char_row+2][char_col] == 2)){ // 박스 아래쪽이 벽이거나 박스이면
                    do_nothing(); // 캐릭터 이동 불가능
                }
                else if (this->map[char_row+2][char_col] == 0){ // 박스 앞이 비어있으면
                    setElement(char_row, char_col, default_map[char_row][char_col]); // 캐릭터 있던 곳은 기본 값
