    ...
    switch(arrow){   
        ...
        */
        ...
        case 75 : // <- 입력
            ...
            else if (map[char_row][char_col-1] == 1){ // 캐릭터 왼쪽이 벽이면
                do_nothing(); // 캐릭터 이동 불가능
            }
            else if (map[char_row][char_col-1] == 2){ // 캐릭터 왼쪽이 박스일 때
                if ((map[char_row][char_col-2] == 1)||(map[char_row][char_col-2] == 2)){ // 박스 왼쪽이 벽이거나 박스이면
                    do_nothing(); // 캐릭터 이동 불가능
                }
                else if (map[char_row][char_col-2] == 0){ // 박스 앞이 비어있으면
                    setElement(char_row, char_col, default_map[char_row][char_col]); // 캐릭터 있던 곳은 기본 값
                    setCharacter(char_row, char_col-1); // 캐릭터와 박스가 함께 왼쪽으로 이동
                    setElement(char_row, char_col-2, 2);
                }
                else if (map[char_row][char_col-2] == 3){ // 박스 앞이 목적지이면
                    setElement(char_row, char_col, default_map[char_row][char_col]); // 캐릭터 있던 곳은 기본 값
                    setCharacter(char_row, char_col-1); // 캐릭터와 박스가 함께 왼쪽으로 이동
        ...
        case 77 : // -> 입력
            ...
            else if (map[char_row][char_col+1] == 1){ // 캐릭터 오른쪽이 벽이면
                do_nothing(); // 캐릭터 이동 불가능
            }
            else if (map[char_row][char_col+1] == 2){ // 캐릭터 오른쪽이 박스일 때
                if ((map[char_row][char_col+2] == 1)||(map[char_row][char_col+2] == 2)){ // 박스 오른쪽이 벽이거나 박스이면
                    do_nothing(); // 캐릭터 이동 불가능
                }
                else if (map[char_row][char_col+2] == 0){ // 박스 앞이 비어있으면
                    setElement(char_row, char_col, default_map[char_row][char_col]); // 캐릭터 있던 곳은 기본 값
        ...
        case 80 : // ↓ 입력
            ...
            else if (map[char_row+1][char_col] == 1){ // 캐릭터 아래쪽이 벽이면
                do_nothing(); // 캐릭터 이동 불가능
            }
            else if (map[char_row+1][char_col] == 2){ // 캐릭터 아래쪽이 박스일 때
                if ((map[char_row+2][char_col] == 1)||(map[char_row+2][char_col] == 2)){ // 박스 아래쪽이 벽이거나 박스이면
                    do_nothing(); // 캐릭터 이동 불가능
                }
                else if (map[char_row+2][char_col] == 0){ // 박스 앞이 비어있으면
                    setElement(char_row, char_col, default_map[char_row][char_col]); // 캐릭터 있던 곳은 기본 값
                    setCharacter(char_row+1, char_col); // 캐릭터와 박스가 함께 아래쪽으로 이동
                    setElement(char_row+2, char_col, 2);
                }
                else if (map[char_row+2][char_col] == 3){ // 박스 앞이 목적지이면
                    setElement(char_row, char_col, default_map[char_row][char_col]); // 캐릭터 있던 곳은 기본 값
                    setCharacter(char_row+1, char_col); // 캐릭터와 박스가 함께 아래쪽으로 이동
                    setElement(char_row+2, char_col, 6); // 목적지에 박스가 들어갔음을 표시
                }
